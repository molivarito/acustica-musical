...
(imprimir 11 copias) más, al final, la especificación de la hoja de
...
cambió entre la primera y la segunda ejecución, y qué se mantuvo?
...
un **vaso golpeado** y una **nota de flauta**, en algún orden. El
...
**Estímulo 2** (minuto 25, dos reproducciones). Escuchará **dos
versiones de un mismo sonido sintetizado**, una tras otra. La versión
...
La **Figura 2** muestra dos espectros de **la misma nota de la misma
cuerda de guitarra**, pulsada en dos puntos distintos.
...
### C.1 — La cuerda del taller (6 puntos)

En un taller de luthería de Santiago se prueba una cuerda de **60 cm**
de largo vibrante, afinada de modo que su fundamental es **220 Hz**
(La3).
...
La cuerda más grave de una guitarra vibra a **82 Hz** (Mi2). Tome
...
### D.1 — Dos columnas (3 puntos)

Clasifique cada término según describa el **sonido físico** (F) o la
**experiencia perceptual** (P). Anote F o P junto a cada uno
(0,5 pts c/u):
...
Una app de espectrograma trabaja con **48 000 muestras por segundo**.
...
El profesor genera las tres figuras esta semana, desde las grabaciones
del banco de estímulos (#10–#12) y con el software del curso, y las
imprime en UNA hoja aparte (tamaño carta, una cara, figuras grandes y
en escala de grises legible).

- **Figura 1 — Espectrograma del par vaso/flauta** (desde el archivo
  del estímulo 3, banco #12): eje horizontal tiempo 0–6 s; eje
  vertical frecuencia 0–4000 Hz **en escala lineal** (imprescindible
  para que las líneas armónicas de la flauta se vean equiespaciadas);
  intensidad = nivel. Deben distinguirse: el vaso como columna breve
  de ataque seguida de 3–4 líneas horizontales **no equiespaciadas**
...
- **Figura 2 — Dos espectros de la misma nota de guitarra** (La3,
  ...
  *Espectro 1*: cuerda pulsada cerca del puente → picos visibles en
  220, 440, 660, 880, 1100, 1320 Hz. *Espectro 2*: cuerda pulsada en
