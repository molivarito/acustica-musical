...
evaluación declarada en `OBJETIVOS_APRENDIZAJE.md`), OA1.2 (proporciones aplicadas:
...
`OBJETIVOS_APRENDIZAJE.md`; rúbrica rápida, cuenta en el 25 % de talleres); (2) el
...
|---|---|---|---|---|
| 0–15′ | **Escucha del día (OA3.1, con nota; OA2.3): se cobra el ticket de s08** | Escucha el estímulo (3′, dos pasadas): la MISMA quinta con tonos complejos, primero lisa y luego "casi igual pero que respira" (~1 ondulación/s); después la misma tercera mayor en dos versiones (una dulce, otra que muele rápido); todos escriben diagnóstico en 3 líneas (2′): describir la diferencia → hipotetizar el mecanismo (¿qué par de parciales se está pisando?) → proponer verificación; **4 sorteados** exponen (**2,5′ c/u, cronómetro visible**) | Opera [`demo_temperamentos.html`](../../demos/demo_temperamentos.html) en modo presentación (números ocultos), alternando afinación justa/igual sobre el mismo intervalo; evalúa con la planilla OA3 (pasada 2) premiando D1 (¿describe la ondulación LENTA de la 5ª vs. el batido RÁPIDO de la 3ª?) y D2 (¿invoca la coincidencia de parciales de s08?); lee 2–3 tickets de s08 y adelanta la respuesta sin desarrollarla: NO, un piano no puede tener todas sus quintas lisas — la mini-lección muestra por qué | [`demo_temperamentos.html`](../../demos/demo_temperamentos.html) proyectada (modo presentación); tickets de s08; planilla rúbrica OA3 (pasada 2); cronómetro |
...
- **Demo** (skill /demo-interactiva): [`demo_temperamentos.html`](../../demos/demo_temperamentos.html) — modo
...
- **Trabajo previo del profesor (esta semana)**: probar
  [`demo_temperamentos.html`](../../demos/demo_temperamentos.html) en el equipo de la sala (alternancia
