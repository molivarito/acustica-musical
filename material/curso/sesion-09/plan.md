...
(afinador y espectrograma bien leídos).
...
día (10′, sin nota) en el primer bloque del módulo 1; módulo 2 abre
con gancho sonoro sin escucha del día; la lectura previa se consume en
la mini-lección del módulo 1 (principio 6). Esta semana hay escucha
del día + 2 talleres; se decide: (1) el **taller EVALUADO de la semana es la
afinación por batidos** (es la evaluación declarada de OA2.3 en
`OBJETIVOS_APRENDIZAJE.md`; rúbrica rápida, cuenta en el 35 % de talleres); (2) el
...
- **Escucha del día**: práctica no calificada; el estímulo exige
  distinguir ondulación lenta (quinta temperada) de batido rápido
  (tercera) y conectar con la coincidencia de parciales de s08; la
...
- **Módulo 1**: 10 + 15 + 37 + 8 = 70′ ✓. Escucha del día: 2′
