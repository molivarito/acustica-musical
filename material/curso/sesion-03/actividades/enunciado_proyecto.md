...
medición y escucha), OA3.2 (conectar oído, mecanismo y medición).
...
- **Hito 1 (OA5.1)**: ¿la predicción es *previa*, explícita y se apoya
...
- **Final (OA5.3, OA3.2)**: ¿la explicación conecta las tres capas —
  ...
  respalda? ¿Las desviaciones respecto del diseño están analizadas?
  ¿El informe respeta las 6 páginas y cita sus fuentes?

Las pautas detalladas con rúbrica de cada hito se entregan al menos una
semana antes de la entrega correspondiente (hito 1: se publica con la
sesión 04).
...
intuición y experimentos; C&G para datos medidos; ROS para ejercicios).
