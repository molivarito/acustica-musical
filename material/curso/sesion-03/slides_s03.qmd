...
| Hito | Fecha | Entrega | % |
|---|---|---|---|
| 1 — Diseño con predicción | vie 04-sep (s05) | predicción escrita + modelo del curso | 10 % |
| 2 — Avance | vie 23-oct (s10) | mediciones + evidencia sonora | 10 % |
| Final | vie 27-nov (s15) | presentación (~25′) + informe ≤ 6 págs | 15 % |
