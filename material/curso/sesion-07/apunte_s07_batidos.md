...
![**Figura 2.** El mecanismo del batido. A la izquierda, dos ondas *en fase*: sus empujones se suman y la resultante tiene el doble de amplitud. A la derecha, *en contrafase*: cuando una empuja la otra succiona y la suma casi se anula. Dos tonos de frecuencias distintas pasan lentamente de una situación a la otra, y ese vaivén es el batido.](../../assets/figuras/s07_fases_batido.svg)
