# Guía de estaciones — Medir lo fuerte (s06, módulo 2, 40 min + cierre)
...
*¿Cuánto vale la app de mi celular comparada con una medición cuidada?*
...
## E2 — El mapa de la sala (celulares)
...
## E3 — ¿Dos fuentes = el doble? (celulares)
...
*¿Cuánto "tiempo de oído" gasta su semana musical?* (Salud auditiva,
dentro de OA4.2.)
...
|---|---|---|---|---|---|---|
| Tiempo diario admisible | 8 h | 4 h | 2 h | 1 h | 30 min | 15 min |
...
| Estación | Predicción | Dato(s) medidos (con unidad) | Condiciones (app/celular/distancia) |
|---|---|---|---|
| E1 | | | |
| E2 | | | |
| E3 | | | |
...
3. **Interpretación**: qué significa, usando correctamente al menos
   una regla (+10 dB = ×10 ≈ doble de sonoridad; +3 dB = ×2).
