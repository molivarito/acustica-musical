...
medición SPL instalada** (lista en [`material/apps_recomendadas.md`](../../apps_recomendadas.md),
...
|---|---|---|---|---|
| 0–5′ | **Re-formación de mesas (tramo 2, s06–s10)** | Se reubica en su nueva mesa según la lista proyectada (roles nuevos: ejecuta / mide y registra / vocero); guarda sus materiales de la mesa anterior | Proyecta la nueva distribución de mesas (mismo criterio de s01: mezcla de familia de instrumento y afinidad tecnológica); asigna roles nuevos; recuerda que el objeto y la bitácora del proyecto siguen siendo individuales — solo cambia el equipo de apoyo | Lista de mesas del tramo 2 proyectada |
| 5–8′ | **Devolución del hito 1 corregido (OA5.1)**, comprimida | Recibe su entrega corregida; anota en su bitácora individual **1 línea de compromiso**: qué corrección incorporará al diseño antes del hito 2 (s10) | Devuelve las 9 entregas corregidas con pauta marcada (repartidas mientras el curso se reubica); comenta al curso en 1′ los 2 aciertos y las 2 debilidades más repetidas (sin nombrar a nadie); instruye qué hacer con la corrección: se responde por escrito en la bitácora y se cobra en el hito 2 | 9 entregas corregidas con pauta; pizarrón |
...
- **Mini-informe SPL por grupo** (formulario de 4 casillas al dorso de
  la planilla, cierre en aula, OA4.2):
...
- **Devolución del hito 1**: 9 bitácoras individuales con línea de
  compromiso escrita (se cobra en el hito 2, s10).
...
- **Experiencia isofónica (m1)**: 27′ = 2′ predicción + 25′ medición;
  1 notebook/grupo ÷ 3 integrantes = ~8′/persona (protocolo ★ de 3
...
- **Demo** (skill /demo-interactiva): [`demo_decibel_sonoridad.html`](../../demos/demo_decibel_sonoridad.html) —
...
- **Apuntes**: [`apunte_s06_sonoridad_y_decibel.md`](apunte_s06_sonoridad_y_decibel.md).
- **Capítulo (lectura previa)**: [`libro/cap06_sonoridad_y_decibel.md`](../../libro/cap06_sonoridad_y_decibel.md).
- **Actividades**: hoja de registro "mi curva isofónica" + guía de
  estaciones de medición de niveles (incluye ítems E4/E5 y pauta del
  mini-informe) — en `actividades/`.
- **Trabajo previo del profesor (esta semana)**: grabar/elegir el
  ...
  9 entregas corregidas del hito 1; **corregir el hito 1 (pico declarado
  ≈2 h, metodología §4)**; sonómetro de referencia para E1 si existe
...
- **La devolución del hito 1 se alarga** (estudiantes que quieren discutir
  su nota) → regla anunciada: hoy solo se lee y se anota el compromiso; las
  apelaciones se resuelven por correo u horario de consulta, no en aula.
- **La re-formación de mesas se come los 5′** (dudas sobre el nuevo
  reparto) → la lista se proyecta ANTES de que entren (preparada la
  semana previa); dudas puntuales se resuelven durante la devolución
  comprimida, no antes de ella.
