...
**Preparación (3 min)**: elijan UNA cuerda con sonido claro (si hay
cuerdas metálicas, mejor). Midan su largo vibrante $L$ (de ceja a
puente): $L =$ ______ cm. Marquen con cinta de papel tres puntos de
pulsación: **$L/2$** (la mitad), **$L/4$** (un cuarto desde el puente) y
**~$L/10$** (pegado al puente).

## 1. Predicción (ANTES de pulsar — 5 min)

Usando la regla de la lectura (pulsar enciende los modos que se *mueven*
en el punto; deja mudos los que tienen *nodo* ahí), anoten sin probar:

| Pulsando en… | ¿Cambia la nota ($f_1$)? sí/no | ¿Qué parciales esperan débiles o MUDOS? | ¿Cómo sonará? (una palabra) |
|---|---|---|---|
| $L/2$ | | | |
| $L/4$ | | | |
| ~$L/10$ (puente) | | | |
