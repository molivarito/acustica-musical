...
equipo de sala, igual para todos); audio SOLO en los 3 momentos del
calendario público — esto protege la equidad (todos oyen lo mismo, las
mismas veces) y acota el manejo de rezagados; el profesor prueba los 3
archivos en el equipo de la sala antes de la clase (regla del banco de
...
- **Prueba 1** (instrumento central de la semana, 12,5 % del curso):
  ...
  (`actividades/prueba1_pauta.md`), ~15 min por estudiante, pico
...
- **Falla el audio de la sala durante la prueba** → los 3 estímulos
  están también en el celular del profesor; se reproducen por el
  parlante del celular caminando por la sala (validado en s05 que se
  oye); si aún así falla, la Parte A se responde sobre el estímulo de
  repuesto en vivo (dos notas de flauta del profesor, misma nota /
  distinto soplo) y la pauta trae la variante.
- **Un estudiante llega muy tarde (después del min 25)** → rinde con el
  tiempo restante y los estímulos de la pasada del min 40; si no
