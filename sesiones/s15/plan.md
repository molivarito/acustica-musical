# Sesión 15 — Presentaciones finales del proyecto: explicar es la prueba
...
- **Línea base (OA3.1, sin nota)**: el contraste s01/hoy es la
  ...
  repite el mismo estímulo y cada estudiante recibe sus dos hojas
  juntas").
- **Cadena de tickets**: s15 no siembra ticket — el cierre es el del
  curso (decisión ya declarada en s14).
...
- **La emoción del cierre se desborda o se enfría** → las voces son
  ...
  UNA media hoja de hoy y deja la comparación en el aire.
