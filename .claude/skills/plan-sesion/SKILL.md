---
name: plan-sesion
description: Genera o revisa la planificación detallada de una sesión del curso de Acústica Musical (2 módulos de 70 min). Usar cuando el usuario pida planificar, estructurar, detallar o revisar una sesión, clase o semana del curso, por ejemplo "planifiquemos la sesión 4" o "arma la clase de modos de vibración".
---

Planificar la sesión $ARGUMENTS del curso.
...
Encabezado con: número de sesión, título, objetivos cubiertos, requisitos
previos. Luego una tabla por módulo con columnas: tiempo, bloque, actividad
del estudiante, rol del profesor, materiales. Cerrar con pendientes de
producción y notas de riesgo (qué puede fallar y plan B).
